...
public class Document {
    ...
    public Document(String description, BigDecimal totalAmount, PersonBase person) {
    ...
    public Document(String description, BigDecimal totalAmount, DocumentStatus status, User createdBy) {
        this.description = description;
        this.totalAmount = totalAmount;
        this.status = status;
